declare const bigInt: BigIntegerStatic;
declare module "big-integer" {
    export = bigInt;
}

/**
 * Result of BigInteger.divmod
 *
 * @interface DivMod
 * @see {@link BigInteger.divmod}
 */
interface DivMod {
    quotient: BigInteger;
...
interface BigIntegerStatic {
     ...
     *
     * @param {string} string
     * @param {(string | number | BigInteger.BigInteger)} [base]
     * @returns {BigInteger.BigInteger}
     */
     ...
     * no-op
     *
     * @param {BigInteger.BigInteger} bigInt
     * @returns {BigInteger.BigInteger}
     */
...
interface BigInteger {
     ...
     * Performs addition
     *
     * @param {(number | string | BigInteger)} number
     * @returns {BigInteger}
     *
     * @memberof BigInteger
     */
     ...
     * @memberof BigInteger
     */
    compare(number: number | string | BigInteger): number;
     ...
     * @memberof BigInteger
     */
    compareAbs(number: number | string | BigInteger): number;
     ...
     * @memberof BigInteger
     */
    divmod(number: number | string | BigInteger): DivMod;
     ...
     * @memberof BigInteger
     */
    eq(number: number | string | BigInteger): boolean;
     ...
     * @memberof BigInteger
     */
    geq(number: number | string | BigInteger): boolean;
     ...
     * @memberof BigInteger
     */
    gt(number: number | string | BigInteger): boolean;
     ...
     *
     * @param {number} [iterations] - optional and determines the amount of iterations of the test (default: 5)
     * @returns {boolean}
     *
     * @memberof BigInteger
     */
     ...
     * @memberof BigInteger
     */
    leq(number: number | string | BigInteger): boolean;
     ...
     * @memberof BigInteger
     */
    lt(number: number | string | BigInteger): boolean;
     ...
     * @memberof BigInteger
     */
    modInv(number: number | string | BigInteger): BigInteger;

    /**
     * Takes the number to the power exp modulo mod.
     *
     * @param {(number | string | BigInteger)} exponent
     * @param {(number | String | BigInteger)} modulus
     * @returns {BigInteger}
     *
     * @memberof BigInteger
     */
    modPow(exponent: number | string | BigInteger, modulus: number | String | BigInteger): BigInteger;
     ...
     * @memberof BigInteger
     */
    neq(number: number | string | BigInteger): BigInteger;
     ...
     * @memberof BigInteger
     */
    shiftLeft(number: number | string | BigInteger): BigInteger;
     ...
     * @memberof BigInteger
     */
    shiftRight(number: number | string | BigInteger): BigInteger;
